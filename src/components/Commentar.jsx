    ...
    >
        ...
        <div className="flex items-start gap-3">
            ...
            <div className="flex-grow min-w-0">
                <div className="flex items-center justify-between gap-4 mb-2">
                    <div className="flex items-center gap-2">
                        <h4 className={`font-medium truncate ${
                            isPinned ? 'text-slate-800' : 'text-slate-600'
                        }`}>
                            {comment.user_name}
                        </h4>
                        {isPinned && (
                            <span className="px-2 py-0.5 text-xs bg-indigo-500/20 text-gray-700 rounded-full">
                                Admin
                            </span>
                        )}
                    </div>
                ...
                <p className="text-slate-600 text-sm break-words leading-relaxed relative bottom-2">
                    {comment.content}
                </p>
            </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2" data-aos="fade-up" data-aos-duration="1000">
                ...
                <input
                    ...
                    className="w-full p-3 rounded-xl bg-white/5 border border-white/10 text-slate-600 placeholder-gray-400 focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all"
                    required
                />
            </div>
            ...
            <div className="space-y-2" data-aos="fade-up" data-aos-duration="1200">
                ...
                <textarea
                    ...
                    className="w-full p-4 rounded-xl bg-white/5 border border-white/10 text-slate-600 placeholder-gray-400 focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all resize-none min-h-[120px]"
                    required
                />
            </div>
            ...
            <button
                ...
                className="relative w-full h-12 bg-gradient-to-r from-[#756AB6] via-[#AC87C5] to-[#E0AED0]
 rounded-xl font-medium text-white overflow-hidden group transition-all duration-300 hover:scale-[1.02] hover:shadow-lg active:scale-[0.98] disabled:opacity-50 disabled:hover:scale-100 disabled:cursor-not-allowed"
            >
            ...
            <div className="p-6 border-b border-white/10" data-aos="fade-down" data-aos-duration="800">
                <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-xl font-semibold text-slate-600">
                        Comments <span className="text-slate-600">({totalComments})</span>
                    </h3>
                </div>
            </div>
